...
1. **Use flake8 to check Python style**: flake8 filename(s) . Note that it misses some things, like consistent usage, so you'll still need to double check your script.

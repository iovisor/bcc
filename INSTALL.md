...
sudo apt install -y zip bison build-essential cmake clang flex git libedit-dev llvm \
...
# For other versions
sudo apt-get -y install zip bison build-essential cmake clang flex git libedit-dev llvm \

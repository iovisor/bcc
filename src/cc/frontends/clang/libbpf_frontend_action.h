...
class BtoLibbpfTypeVisitor : public clang::RecursiveASTVisitor<BtoLibbpfTypeVisitor> {
 public:
  explicit BtoLibbpfTypeVisitor(clang::ASTContext &C, BtoLibbpfFrontendAction &fe);
...
class BtoLibbpfTypeConsumer : public clang::ASTConsumer {
 ...
 private:
  ...
  BtoLibbpfTypeVisitor btype_visitor_;
...
class BtoLibbpfFrontendAction : public clang::ASTFrontendAction {
 ...
 private:
  ...
  friend class BtoLibbpfTypeVisitor;

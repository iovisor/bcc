...
lib.bpf_table_key_snprintf.argtypes = [
    ct.c_void_p,
    ct.c_ulonglong,
    ct.c_char_p,
    ct.c_ulonglong,
...
lib.bpf_table_leaf_snprintf.argtypes = [
    ct.c_void_p,
    ct.c_ulonglong,
    ct.c_char_p,
    ct.c_ulonglong,
...
lib.bpf_table_key_sscanf.argtypes = [
    ct.c_void_p,
    ct.c_ulonglong,
    ct.c_char_p,
    ct.c_void_p,
...
lib.bpf_table_leaf_sscanf.argtypes = [
    ct.c_void_p,
    ct.c_ulonglong,
    ct.c_char_p,
    ct.c_void_p,
...
lib.bpf_update_elem.argtypes = [ct.c_int, ct.c_void_p, ct.c_void_p, ct.c_ulonglong]
...
lib.bpf_open_perf_buffer.argtypes = [
    _RAW_CB_TYPE,
    _LOST_CB_TYPE,
    ct.py_object,
    ct.c_int,
...
lib.bpf_attach_perf_event.argtype = [
    ct.c_int,
    ct.c_uint,
    ct.c_uint,
    ct.c_ulonglong,
...
class bcc_ip_offset_union(ct.Union):
    _fields_ = [("offset", ct.c_uint64), ("ip", ct.c_uint64)]
...
lib.bcc_buildsymcache_resolve.argtypes = [
    ct.c_void_p,
    ct.POINTER(bcc_stacktrace_build_id),
    ct.POINTER(bcc_symbol),
]
...
lib.bcc_symcache_resolve.argtypes = [
    ct.c_void_p,
    ct.c_ulonglong,
    ct.POINTER(bcc_symbol),
]
...
lib.bcc_symcache_resolve_no_demangle.argtypes = [
    ct.c_void_p,
    ct.c_ulonglong,
    ct.POINTER(bcc_symbol),
]
...
class bcc_usdt_location(ct.Structure):
    _fields_ = [("address", ct.c_ulonglong), ("bin_path", ct.c_char_p)]
...
lib.bcc_usdt_get_location.argtypes = [
    ct.c_void_p,
    ct.c_char_p,
    ct.c_char_p,
    ct.c_int,
...
lib.bcc_usdt_get_argument.argtypes = [
    ct.c_void_p,
    ct.c_char_p,
    ct.c_char_p,
    ct.c_int,
    ct.c_int,
    ct.POINTER(bcc_usdt_argument),
]

_USDT_PROBE_CB = ct.CFUNCTYPE(None, ct.c_char_p, ct.c_char_p, ct.c_ulonglong, ct.c_int)

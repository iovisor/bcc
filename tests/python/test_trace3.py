...
class TestBlkRequest(TestCase):
    def setUp(self):
        ...
        b.attach_kprobe(event="blk_start_request", fn_name="probe_blk_start_request")
        b.attach_kprobe(event="blk_update_request", fn_name="probe_blk_update_request")
    ...
    def test_blk1(self):
        ...
        for i in range(0, 2):
            subprocess.call(
                ["dd", "if=/dev/zero", "of=/opt/trace3.txt", "count=1024", "bs=4096"]
            )

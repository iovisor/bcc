...
parser.add_argument(
    "-i", "--interval", default=99999999, help="summary interval, seconds"
)
parser.add_argument(
...
parser.add_argument("pattern", help="search expression for kernel functions")
...
# header
print('Tracing %d functions for "%s"... Hit Ctrl-C to end.' % (matched, args.pattern))
